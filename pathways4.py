...
if st.sidebar.button("Submit"):
    ...
    if response.status_code == 200:
        ...
        # Display Total Emissions and Energy Consumption
        st.subheader("Total Calculations")
        st.write(f"**Total Emissions:** {total_emissions:.2f} kgCO2")
        st.write(f"**Total Energy Consumption:** {total_energy_consumption:.2f} kWh")
        ...
        plt.plot(years, benchmark_emissions, label="Benchmark Emissions (kgCO2/ft²)", color="blue",
